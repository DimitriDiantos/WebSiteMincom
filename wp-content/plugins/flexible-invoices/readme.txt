=== Flexible PDF Invoices for WordPress ===
Contributors: wpdesk,dyszczo,grola,piotrpo,marcinkolanko
Donate link: https://www.wpdesk.net/flexible-invoices-woocommerce/
Tags: invoices, order invoice, pdf invoice, pdf invoices, automatic billing, automatic invoice, billing invoice, download invoice, email invoice, shop invoice, wordpress invoicing, woocommerce invoice, woocommerce download invoice, woocommerce invoicing, woocommerce billing, woocommerce vat number, eu invoices, european invoices, pdf, invoice translations, multi-language invoice,
...
Easy invoicing plugin for WordPress with PDF support. Supercharge it by installing the extension to issue invoices for WooCommerce to get great new options e.g. invoicing under European Union law.

== Description ==

Flexible PDF Invoices for WordPress is a plugin that allows you to create PDF invoices in WordPress for free. With the extension, you may issue invoices in WooCommerce. With the free plugin you can:
generate invoices as PDFs,

* manage currencies, tax rates, and payment methods,
* generate reports,
* download invoices in bulk and more.
* Use Flexible PDF Invoices for WordPress to bill your clients with ease.
* Create invoices automatically in your WooCommerce shop with the paid extension [Flexible Invoices for WooCommerce](https://www.wpdesk.net/products/flexible-invoices-woocommerce).
= Features =

* Issue and save invoices as PDFs
* Add, edit and delete invoices (invoices are stored as Custom Post Types)
* Manage currencies, tax rates, and payment methods
* Create PDF templates ready for VAT taxpayers and VAT-exempt entities
* Generate and download invoices in bulk by a date range
* Use custom numbering with shortcodes and by adding your own prefixes and suffixes
* Set the initial number for invoices so you may begin using the plugin throughout the year
* Prepare reports with a summary of all documents issued in a chosen date range
* Translate invoices into languages of your customers by using WPML or Polylang.

Visit [Flexible Invoices Docs](https://www.wpdesk.net/docs/flexible-invoices-docs/) to see how to use the full potential of the plugin.
...
* [PRO] Automatic invoices for WooCommerce orders
* [PRO] Invoices compatible with EU law
* [PRO] MOSS support
* [PRO] Conversion of VAT into local currency
* [PRO] VAT number validation in the VIES database
* [PRO] Correction invoices
* [PRO] Bulk downloading of invoices
...
[Upgrade to PRO Now →](https://www.wpdesk.net/products/flexible-invoices-woocommerce/)
...
Yes, but you need to purchase an extension [Flexible Invoices for WooCommerce](https://www.wpdesk.net/products/flexible-invoices-woocommerce/).
...
4. General Settings.
5. Invoices Settings.
6. Bulk Generate and Download Invoices.
7. Currency Settings.
8. Tax Settings.
9. Payment Methods.
...
If you want to upgrade from the old WordPress Invoices version (3.2.1, wordpress-invoices) make sure to completely delete the old plugin first. Your data and invoices will be kept intact. If you install the new version without deleting the old one you may break your WordPress installation.
...
* Fixed download reports and invoices
