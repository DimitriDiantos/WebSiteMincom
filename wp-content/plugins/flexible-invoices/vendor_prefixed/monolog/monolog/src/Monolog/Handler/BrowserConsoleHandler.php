 ...
 */
class BrowserConsoleHandler extends \WPDeskInvoicesVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \WPDeskInvoicesVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
