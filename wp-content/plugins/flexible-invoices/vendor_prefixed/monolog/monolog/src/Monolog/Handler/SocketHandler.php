 ...
 */
class SocketHandler extends \WPDeskInvoicesVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \WPDeskInvoicesVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
