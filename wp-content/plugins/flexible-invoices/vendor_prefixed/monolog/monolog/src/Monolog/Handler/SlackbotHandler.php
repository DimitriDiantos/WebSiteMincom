 ...
 */
class SlackbotHandler extends \WPDeskInvoicesVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \WPDeskInvoicesVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
