 ...
 */
class RotatingFileHandler extends \WPDeskInvoicesVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \WPDeskInvoicesVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \WPDeskInvoicesVendor\Monolog\Utils::canonicalizePath($filename);
