...
namespace WPDeskInvoicesVendor\WPDesk\Tests\WC\Helpers\Product;

use WPDeskInvoicesVendor\WPDesk\WC\Helper\Factory;
class Product_Helper
{
    ...
    {
        $product = \WPDeskInvoicesVendor\WC_Helper_Product::create_simple_product();
        $compatibilityFactory = \WPDeskInvoicesVendor\WPDesk\WC\Helper\Factory::create_compatibility_helper_factory();
