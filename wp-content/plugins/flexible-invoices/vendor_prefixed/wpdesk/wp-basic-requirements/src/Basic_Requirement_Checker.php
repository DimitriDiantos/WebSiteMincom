...
if (!\interface_exists('WPDeskInvoicesVendor\\WPDesk_Requirement_Checker')) {
    require_once 'Requirement_Checker.php';
}
if (!\class_exists('WPDeskInvoicesVendor\\WPDesk_Basic_Requirement_Checker')) {
    /**
     * Checks requirements for plugin
     * have to be compatible with PHP 5.3.x
     */
    class WPDesk_Basic_Requirement_Checker implements \WPDeskInvoicesVendor\WPDesk_Requirement_Checker
    {
        ...
        {
            return \defined('WPDeskInvoicesVendor\\WC_VERSION') && \version_compare(\WPDeskInvoicesVendor\WC_VERSION, $min_version, '>=');
        }
        /**
