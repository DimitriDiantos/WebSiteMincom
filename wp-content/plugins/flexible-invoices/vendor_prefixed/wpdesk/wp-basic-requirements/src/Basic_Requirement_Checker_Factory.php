...
if (!\class_exists('WPDeskInvoicesVendor\\Basic_Requirement_Checker')) {
    require_once 'Basic_Requirement_Checker.php';
}
if (!\class_exists('WPDeskInvoicesVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
...
class WPDesk_Basic_Requirement_Checker_Factory
{
    ...
    {
        return new \WPDeskInvoicesVendor\WPDesk_Basic_Requirement_Checker($plugin_file, $plugin_name, $text_domain, null, null);
    }
    /**
    ...
    {
        $requirements_checker = new \WPDeskInvoicesVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp']);
