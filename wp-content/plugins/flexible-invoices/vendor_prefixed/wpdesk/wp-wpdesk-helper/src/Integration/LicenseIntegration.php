...
use WPDeskInvoicesVendor\WPDesk\License\Page\LicensePage;
use WPDeskInvoicesVendor\WPDesk\PluginBuilder\Plugin\Hookable;
use WPDeskInvoicesVendor\WPDesk\License\InstalledPlugins;
/**
 * Integrates WP Desk licenses with WordPress
 *
 * @package WPDesk\Helper
 */
class LicenseIntegration implements \WPDeskInvoicesVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \WPDeskInvoicesVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \WPDeskInvoicesVendor\WPDesk\License\Page\LicensePage($plugin_registry);
