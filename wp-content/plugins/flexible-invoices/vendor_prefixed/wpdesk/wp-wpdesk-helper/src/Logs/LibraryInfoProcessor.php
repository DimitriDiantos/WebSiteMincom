...
namespace WPDeskInvoicesVendor\WPDesk\Helper\Logs;

use WPDeskInvoicesVendor\Monolog\Processor\ProcessorInterface;
 ...
 */
class LibraryInfoProcessor implements \WPDeskInvoicesVendor\Monolog\Processor\ProcessorInterface
{
    /** @var LibraryDebug */
    private $library_debug;
    public function __construct(\WPDeskInvoicesVendor\WPDesk\Helper\Debug\LibraryDebug $library_debug)
    {
