...
use WPDeskInvoicesVendor\Monolog\Handler\AbstractProcessingHandler;
use WPDeskInvoicesVendor\Monolog\Logger;
/**
 * Class WooCommerceFactory
 */
class WooCommerceHandler extends \WPDeskInvoicesVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return \WPDeskInvoicesVendor\Monolog\Logger::getLevelName($level);
    }
