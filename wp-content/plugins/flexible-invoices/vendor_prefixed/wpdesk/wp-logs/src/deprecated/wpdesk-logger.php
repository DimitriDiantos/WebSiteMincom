...
if (!\class_exists('WPDeskInvoicesVendor\\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \WPDeskInvoicesVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            if (\defined('WPDeskInvoicesVendor\\WC_VERSION')) {
                if (\version_compare(\WPDeskInvoicesVendor\WC_VERSION, '3.0', '<')) {
