 ...
 */
class InfoBuilder extends \WPDeskInvoicesVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\WPDeskInvoicesVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
