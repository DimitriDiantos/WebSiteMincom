...
if (!\interface_exists('WPDeskInvoicesVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\class_exists('WPDeskInvoicesVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\class_exists('WPDeskInvoicesVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \WPDeskInvoicesVendor\WPDesk_Translatable, \WPDeskInvoicesVendor\WPDesk_Buildable, \WPDeskInvoicesVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
