...
namespace WPDeskInvoicesVendor\WPDesk\Plugin\Flow;

use WPDeskInvoicesVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
final class PluginBootstrap
{
     ...
     */
    public function __construct($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, array $requirements, $product_id, \WPDeskInvoicesVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory $build_factory)
    {
     ...
     */
    private function init_translations(\WPDeskInvoicesVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \WPDeskInvoicesVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \WPDeskInvoicesVendor\WPDesk_Plugin_Info();
