...
namespace WPDeskInvoicesVendor\WPDesk\WC;
...
class RequirementChecker
{
    ...
    {
        $plugin_data = \get_file_data($file, array('title' => 'Plugin Name'));
    ...
    {
        return \defined('WPDeskInvoicesVendor\\WC_VERSION') && \version_compare(WC_VERSION, $min_version, '>=');
    }
}
