...
use WPDeskInvoicesVendor\Composer\Downloader\FilesystemException;
 ...
 */
class CreateCodeceptionTests extends \WPDeskInvoicesVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \WPDeskInvoicesVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
