...
use WPDeskInvoicesVendor\WPDesk\License\ServerAddressRepository;
use WPDeskInvoicesVendor\WPDesk_API_Manager_With_Update_Flag;
/**
 * Can activate plugin license.
 *
 * @package WPDesk\License\Page\License\Action
 */
class LicenseActivation implements \WPDeskInvoicesVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    public function execute(array $plugin)
    {
        ...
        $this->activate_license($activation_email, $api_key, new \WPDeskInvoicesVendor\WPDesk\License\ServerAddressRepository($product_id));
    }
    /**
     ...
     */
    public function activate_license($activation_email, $api_key, \WPDeskInvoicesVendor\WPDesk\License\ServerAddressRepository $address_repository)
    {
