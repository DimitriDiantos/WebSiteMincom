...
class Flexible_Invoices_Translator {
	...
	const FIELDS_WOO = [
		...
		'inspire_invoices_woocommerce_vat_moss_description'       => 'Reverse Charge'
	];

	private static $plugin_info;

	private static $text_domain = 'flexible-invoices';
	private static $text_domain_woo = 'flexible-invoices-woocommerce';
	...
	public static function init( WPDeskInvoicesVendor\WPDesk_Plugin_Info $plugin_info ) {
	...
	private static function translate_registered_string( $loaded_mo, $textdomain, $string_id, $icl_string ) {
		global $l10n;
		$translator_id = ( icl_st_is_translator() && get_current_user_id() > 0 ) ? get_current_user_id() : null;
