...
<style type="text/css">
    ...
    @font-face {
        ...
        src:url('<?php use rednaoformpdfbuilder\core\Loader;use rednaoformpdfbuilder\htmlgenerator\generators\FileManager;use rednaoformpdfbuilder\pr\Utilities\FontManager;echo $rninstance->URL?>vendor/dompdf/dompdf/lib/fonts/DejaVuSans.ttf');
    ...
    .PDFElement.CustomField{
        text-align:left;
    }

    .PDFElement.CustomField .FieldLabel{
        font-weight:bold;
        vertical-align:top;
    }

    .PDFElement.CustomField Table{
        width:100%;
    }

    .PDFElement.CustomField .FieldLabel .Top{
        margin-bottom:2px;
    }
    .PDFElement.CustomField .FieldLabel .Bottom{
        margin-top:2px;
    }
    .PDFElement.CustomField .FieldLabel .Left{
        margin-right:2px;
    }
    .PDFElement.CustomField .FieldLabel .Right{
        margin-left:2px;
    }
