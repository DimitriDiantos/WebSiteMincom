...
abstract class AbstractFrameDecorator extends Frame
{
    ...
    public function AdjustSiblingPosition()
    {
        ...
        $originalBottom=\floatval($this->_frame->pdfField->Styles->Top)+floatval($pdfField->DesignerHeight);
        ...
        $newBottom=floatval($originalStyles->top)+$height*96/72;
        $delta=$newBottom-$originalBottom;
